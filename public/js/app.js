// app.js - v1.6.0-stable
// FIX: sessionStorage + HTTP filter + DOM validation
...
async function loadSources() {
  ...
  try {
    ...
    // ✅ FIX: FILTRAR SOLO HTTP DIRECTOS (NO TORRENTS)
...
function renderSources() {
  ...
  // ✅ FIX: VALIDAR QUE ELEMENTO EXISTE
  const btnCreateRoom = document.getElementById('btnCreateRoom');
...
async function createRoom() {
  ...
  try {
    ...
    if (data.success) {
      ...
      console.log('✅ Sala creada, redirigiendo a /sala/' + roomId);
